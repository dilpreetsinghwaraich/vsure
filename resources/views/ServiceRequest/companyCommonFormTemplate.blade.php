...
if (!empty($serviceForm->form_fields) && is_array($serviceForm->form_fields)) {
  ...
  foreach ($serviceForm->form_fields as $form_key => $form_value) {
    ...
    <div class="content-main company_profile <?php echo $activeContent; ?> " data-tabComp="prog_tab_<?php echo $form_key ?>" id="companyCommonFormTemplate_<?php echo $form_key ?>">
          ...
          foreach ($form_value['field'] as $field_key => $field_value) {
            ...
            if (isset($field_value['text']) && !empty($field_value['text'])) {
              ...
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input class="form-control emptyFieldCheck emptyFieldCheck1" id="focusedInput" type="text" name="company_details[text_<?php echo $form_key; ?>_<?php echo $field_key; ?>]" value="<?php echo (isset($company_details['text_'.$form_key.'_'.$field_key])?$company_details['text_'.$form_key.'_'.$field_key]:'') ?>" required data-placeholder="<?php echo $field_value['text']['title'] ?>">
                </div>
              </div>
              <?php
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    ...
                    if (isset($company_details['file_'.$form_key.'_'.$field_key])?$company_details['file_'.$form_key.'_'.$field_key]:'')
                    {
                      ...
                      ?>
                      <input type="hidden" class="emptyFieldCheck1" value="<?php echo $file; ?>">
                      <?php
              ...
              ?>
                <div class="form-group">
                  ...
                  <div class="col-sm-12">
                    <input class="form-control emptyFieldCheck emptyFieldCheck1 vsureDatepicker" name="company_details[date_<?php echo $form_key; ?>_<?php echo $field_key; ?>]" type="text" value="<?php echo (isset($company_details['date_'.$form_key.'_'.$field_key])?$company_details['date_'.$form_key.'_'.$field_key]:'') ?>" required data-placeholder="<?php echo $field_value['date']['title'] ?>">
                  </div>
                </div>
              <?php
                    ...
                    $radioDefaultValue = (isset($company_details['radio_'.$form_key.'_'.$field_key])?$company_details['radio_'.$form_key.'_'.$field_key]:'');
                      ...
                      if (!empty($radios)) {
                        foreach ($radios as $radio) {
                          ?>
                           <label><input type="radio" class="emptyFieldCheck emptyFieldCheck1" name="company_details[radio_<?php echo $form_key; ?>_<?php echo $field_key; ?>]" value="<?php echo $radio ?>" <?php echo ($radioDefaultValue == $radio?'checked':'') ?> data-placeholder="<?php echo $field_value['radio']['title'] ?>"><?php echo $radio ?></label>
                          <?php
                        }
                      }
                    ?>    
              ...
              ?>
                <div class="form-group">
                  ...
                  <div class="col-sm-12" style="">
                    <select class="form-control emptyFieldCheck emptyFieldCheck1" name="company_details[select_<?php echo $form_key; ?>_<?php echo $field_key; ?>]" id="sel<?php echo $field_key; ?>" data-placeholder="<?php echo $field_value['select']['title'] ?>">
      ...
      if ($type == 'index') {        
        ...
        }else
        {
          ...
          <div class="company-page-form-btn">
            <div class="col-sm-12">
              <button type="button" class="btn btn-default submit_form_button" data-tabComp="prog_tab_<?php echo $form_key ?>" data-tabKey="tab_<?php echo $form_key ?>">Save & Continue</button>
            </div>
          </div>
          <?php
        }
