...
<div class="content-main">
	...
	<div class="col-lg-9 col-xs-12 showProfile">
		...
		<p class="profile-city"><span>City</span><?php echo Helper::getCity($profile->city); ?></p>
		<p class="profile-state"><span>State</span><?php echo Helper::getState($profile->state); ?></p>
		<p class="profile-country"><span>Country</span><?php echo Helper::getCountry($profile->country). (!empty($profile->postal_code)?'('.$profile->postal_code.')':''); ?></p>
