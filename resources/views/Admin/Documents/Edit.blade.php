              ...
              <?php echo Form::open(array('url' => 'admin/update/document/'.$document->document_id, 'method' => 'post')) ?>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control" id="document_promoter" name="document_promoter" required placeholder="Document of promoter"><?php echo $document->document_promoter ?></textarea>
                  </div>
                  <div class="form-group col-md-12">
                    <label for="document_company">Document of company</label>
                    <textarea class="form-control" id="document_company" name="document_company" required placeholder="Document of company"><?php echo $document->document_company ?></textarea>
                  </div>
                  <div class="form-group col-md-12">
