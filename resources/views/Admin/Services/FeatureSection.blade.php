<div class="form-group col-md-12">
  ...
  <div class="form-group col-md-12">
    ...
    <textarea class="form-control textarea" id="feature_content" name="service_features[content]" placeholder="Content"><?php echo (isset($service_features['content'])?$service_features['content']:''); ?></textarea>
  </div>
  <div class="form-group col-md-12">
