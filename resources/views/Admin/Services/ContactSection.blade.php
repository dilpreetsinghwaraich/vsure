<div class="form-group col-md-12">
  ...
  <div class="form-group col-md-12">
    ...
    <textarea class="form-control textarea" id="contact_content" name="service_short_info[content]" placeholder="Content"><?php echo (isset($service_short_info['content'])?$service_short_info['content']:''); ?></textarea>
  </div>
  <div class="form-group col-md-12">
