              ...
              <?php echo Form::open(array('url' => 'admin/update/process/result/'.$processResult->process_id, 'method' => 'post', 'files'=>true)) ?>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control textarea" id="process_content" name="process_content" required placeholder="Content"><?php echo $processResult->process_content ?></textarea>
                  </div>
                  <div class="form-group col-md-12">
                    ...
                    <select name="process_terms" id="process_terms" class="form-control select2-multiple multiSelect">
                      ...
                      <?php
                        foreach ($terms as $term) {
                          echo "<option value='".$term->term_id."' ".($term->term_id = $processResult->process_terms?"selected":"").">".$term->term_title."</option>";
                        }
                      ?>
                    </select>
                  </div>
