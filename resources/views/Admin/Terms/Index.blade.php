                  ...
                  <?php echo Form::open(array('url' => 'admin/save/term/', 'method' => 'post')) ?>
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <textarea class="form-control textarea" id="term_content" name="term_content" required placeholder="Term Content"><?php echo old('term_content'); ?></textarea>
                      </div>
                      <div class="form-group col-md-12">
                        <label for="term_type">Term Type</label>
                        <select class="form-control" id="term_type" name="term_type" required >
                          <option value="">Select</option>
                          <option value="blog" <?php echo (old('term_type') == 'blog'?'selected':''); ?>>Blog</option>
