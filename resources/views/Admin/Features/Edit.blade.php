              ...
              <?php echo Form::open(array('url' => 'admin/update/feature/'.$feature->feature_id, 'method' => 'post', 'files'=>true)) ?>
                <div class="form-row">
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <textarea class="form-control textarea" id="feature_content" name="feature_content" required placeholder="Content"><?php echo $feature->feature_content ?></textarea>
                  </div>
                  <div class="form-group col-md-12">
                    ...
                    <select name="feature_terms" id="feature_terms" class="form-control select2-multiple multiSelect">
                      ...
                      <?php
                        foreach ($terms as $term) {
                          echo "<option value='".$term->term_id."' ".($term->term_id = $feature->feature_terms?"selected":"").">".$term->term_title."</option>";
                        }
                      ?>
                    </select>
                  </div>
